...
<form action="#" method="post">
	<table>
		...
		<tr><th>封面图号</th><td><input type="text" name="img_id" value="<?php echo $product->img_id;?>" /> <a href="<?php echo base_url();?>album/view/<?php echo $product->id;?>" target="_blank">查看相册</a></td></tr>
